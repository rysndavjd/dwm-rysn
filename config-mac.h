...
static const char *fonts[]          = { "cantarell:size=20", "Symbols Nerd Font Mono:pixelsize=50" };
...
static const char *kbbacklightdec[]  = { "cpplighty", "--device", "kbd_backlight", "--dec", "5", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|ControlMask,           XK_p, spawn,          {.v = flameshot } },
	{ MODKEY,             			XK_l, spawn,          {.v = lock } },	
	{ MODKEY,             			XK_F3, spawn,          {.v = extdisplay } },
